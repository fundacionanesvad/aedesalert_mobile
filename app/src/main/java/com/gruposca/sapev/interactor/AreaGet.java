...
public class AreaGet extends AbsInteractor<Area> {

    private final AreaRepository areaRepository;
    private Integer areaId;

    @Inject
    public AreaGet(ThreadExecutor threadExecutor, PostThreadExecutor postThreadExecutor, AreaRepository areaRepository) {
        super(threadExecutor, postThreadExecutor);
        this.areaRepository = areaRepository;
    }

    public void execute(Integer areaId, Callback<Area> callback) {
        this.areaId = areaId;
    ...
    public void run() {
        try {
            notifyResponse(areaRepository.getArea(areaId));
        } catch (Exception e) {
            notifyError(e);
        }
    }
