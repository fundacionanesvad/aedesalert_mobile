...
public class HouseHasVisitInProgress extends AbsInteractor<Boolean> {

    private final HouseRepository houseRepository;

    @Inject
    public HouseHasVisitInProgress(ThreadExecutor threadExecutor, PostThreadExecutor postThreadExecutor, HouseRepository houseRepository) {
    ...
    public void run() {
        try {
            notifyResponse(houseRepository.hasVisitInProgress());
        } catch (Exception e) {
            notifyError(e);
        }
    }
