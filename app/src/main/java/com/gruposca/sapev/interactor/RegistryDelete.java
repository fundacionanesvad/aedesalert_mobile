...
public class RegistryDelete extends AbsInteractor<List<InventoryListQuery>> {
    ...
    @Inject
    public RegistryDelete(ThreadExecutor threadExecutor, PostThreadExecutor postExecutionThread, RegistryRepository registryRepository, InventoryRepository inventoryRepository) {
    ...
    public void run() {
        try {
            registryRepository.deleteRegistry(registryUuid);
