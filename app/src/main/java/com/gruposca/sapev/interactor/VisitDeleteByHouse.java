...
public class VisitDeleteByHouse extends AbsInteractor<Void> {
    ...
    @Inject
    public VisitDeleteByHouse(ThreadExecutor threadExecutor, PostThreadExecutor postThreadExecutor, VisitRepository visitRepository, HouseRepository houseRepository) {
        super(threadExecutor, postThreadExecutor);
        this.visitRepository = visitRepository;
        this.houseRepository = houseRepository;
    }

    public void execute(String houseUuid, Callback<Void> callback) {
    ...
    public void run() {
        try {
            visitRepository.deleteVisitByHouse(houseUuid);
