 ...
 */
public class HouseDelete extends AbsInteractor<Void> {

    private HouseRepository houseRepository;
    private House house;

    @Inject
    public HouseDelete(ThreadExecutor threadExecutor, PostThreadExecutor postExecutionThread, HouseRepository houseRepository) {
