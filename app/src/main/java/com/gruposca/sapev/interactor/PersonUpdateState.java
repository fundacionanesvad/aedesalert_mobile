...
public class PersonUpdateState extends AbsInteractor<Void> {

    protected PersonRepository personRepository;
    private String personUuid;

    @Inject
    public PersonUpdateState(ThreadExecutor threadExecutor, PostThreadExecutor postExecutionThread, PersonRepository personRepository) {
        super(threadExecutor, postExecutionThread);
        this.personRepository = personRepository;
    }

    public void execute(String personUuid, Callback<Void> callback) {
    ...
    public void run() {
        try {
            Person person = personRepository.getPerson(personUuid);
