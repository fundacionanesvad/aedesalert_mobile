...
public class InventorySummaryAdapter extends AbsAdapter<InventorySummaryQuery, InventorySummaryAdapter.InventoryViewHolder> {
    ...
    protected int getItemLayoutResourceId() {
        return R.layout.item_summary_inventory;
    }
    ...
    public void onBindViewHolder(InventoryViewHolder viewHolder, int i) {
        InventorySummaryQuery item = getItem(i);
