...
public interface InventoryListPresenter {

    void setView(View view, String visitUuid);
    void loadInventoryList();
    void deleteRegistry(String registryUuid);
    void restoreRegistry(String registryUuid);
    ...
    interface View {
        ...
        void showInventories(List<InventoryListQuery> inventories);
        void onDeleteVisit();
    }
}